...
public class ZoneAnalysis {
    ...
    private Integer supermarketCount500m = 0;
    private Integer pharmacyCount500m = 0;
    private Integer gymCount1000m = 0;
    private Integer parkCount1000m = 0;
    private Integer restaurantCount1000m = 0;
    private Integer healthCenterCount2000m = 0;
    private Integer shoppingCenterCount3000m = 0;
    private BigDecimal entertainmentScore = BigDecimal.ZERO;
    private BigDecimal transportScore = BigDecimal.ZERO;
